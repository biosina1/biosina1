				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row justify-content-center align-items-center">
							<div class="col-xs-12">
								<center>
									<a href="#" id="register-form-link">회원 정보</a>
								</center>
							</div>
						</div>
						<hr>
					...
					<div class="panel-body">
						<div class="row justify-content-center align-items-center">
							<div class="col-md-12">
								<form id="register-form" action="/member/modify" method="post"
									...
									<div class="form-group">
										<input type="addr2" name="addr2" id="addr2" tabindex="2"
											class="form-control" placeholder="상세주소" value="${user.addr2}">
									</div>
									<div class="form-group">
										<input type="email" name="email" id="email" tabindex="2"
											class="form-control" placeholder="이메일" value="${user.email}">
									</div>
									<div class="form-group">
										<input type="tel" name="phone" id="phone" tabindex="2"
											class="form-control" placeholder="전화번호" value="${user.phone}">
									</div>
									<div class="form-group">
										<div class="row justify-content-center align-items-center">
